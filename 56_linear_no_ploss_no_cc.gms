...
parameters ploss,ploss_t,vmg_p,vrms,THDv,qst,c_p,c_q;
...
,p.l,q.l,ir.l,iim.l,inlr.l,inlim.l,istr.l,istim.l,sst.l,pst.l,qst,vr.l,vim.l,vrms,ploss,ploss_t;

execute_unload "results_56_no_c_no_ploss.gdx" VRMS
execute 'gdxxrw.exe results_56_no_c_no_ploss.gdx par=VRMS rng=classic1!'
execute_unload "results_56_no_c_no_ploss.gdx" ir
execute 'gdxxrw.exe results_56_no_c_no_ploss.gdx Var=ir rng=classic2!'
execute_unload "results_56_no_c_no_ploss.gdx" iim
execute 'gdxxrw.exe results_56_no_c_no_ploss.gdx Var=iim rng=classic3!'
execute_unload "results_56_no_c_no_ploss.gdx" THDv
execute 'gdxxrw.exe results_56_no_c_no_ploss.gdx par=THDv rng=classic4!'
execute_unload "results_56_no_c_no_ploss.gdx" pst
execute 'gdxxrw.exe results_56_no_c_no_ploss.gdx var=pst rng=classic5!'
execute_unload "results_56_no_c_no_ploss.gdx" qst
execute 'gdxxrw.exe results_56_no_c_no_ploss.gdx par=qst rng=classic6!'
execute_unload "results_56_no_c_no_ploss.gdx" sst
execute 'gdxxrw.exe results_56_no_c_no_ploss.gdx var=sst rng=classic7!'
execute_unload "results_56_no_c_no_ploss.gdx" ploss
execute 'gdxxrw.exe results_56_no_c_no_ploss.gdx par=ploss rng=classic8!'
**************************************************88
execute_unload "results_56_no_c_no_ploss.gdx" S_Ex
execute 'gdxxrw.exe results_56_no_c_no_ploss.gdx par=S_Ex rng=classic9!'
execute_unload "results_56_no_c_no_ploss.gdx" S_Ex_t
execute 'gdxxrw.exe results_56_no_c_no_ploss.gdx par=S_Ex_t rng=classic10!'

execute_unload "results_56_no_c_no_ploss.gdx" Ex_PEVs
execute 'gdxxrw.exe results_56_no_c_no_ploss.gdx par=Ex_PEVs rng=classic11!'
execute_unload "results_56_no_c_no_ploss.gdx" Ex_t
execute 'gdxxrw.exe results_56_no_c_no_ploss.gdx par=Ex_t rng=classic12!'
